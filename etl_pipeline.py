...
from pyspark.sql.functions import col, date_format, sum, when, count
...
# Replace 'nan' strings with None, drop rows with nulls, remove duplicates, and cast columns
...
# Replace 'null' strings with None, drop rows with nulls, remove duplicates, and cast columns
...
# Join aggregated sales back to sales DataFrame
...
# Join the result with stores DataFrame on store_id
